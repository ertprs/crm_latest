...
<div class="ciuis-body-content lead-single quote-single" ng-controller="Customer_Controller">
                ...
                <md-content class="bg-white" style="border-right:1px solid #e0e0e0;">
                    ...
                    <md-list-item>
                                ...
                                <img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['company']?></p>[COMPANY NAME]
                                </md-list-item>
                                <md-list-item>
                                
                                <img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['name']?></p>[Business Type]
                                </md-list-item>
                                <md-list-item>
                                
                                <img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['account_contact_number']?></p>[CONTACT PERSON (ACCOUNTS)]
                                </md-list-item>
                    <md-list-item>
                                <!--    <md-icon class="ion-android-call"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['email']?></p>[CONTACT PERSON EMAIL(ACCOUNTS)]
                                </md-list-item>
                                ...
                                <img src="<?php echo base_url('uploads/images/contact_person.jpg') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['address']?></p>[Company Address]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                ...
                                <img src="<?php echo base_url('uploads/images/credit_period.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ng-bind="<?php print $customers['taxoffice']?>"></p>[VAT OFFICE]
                                </md-list-item>
                                <md-divider></md-divider>
                                    <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/credit_limit.jpg') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ng-bind="<?php print $customers['taxnumber']?>"></p>[VAT NUMBER]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/lisence_nmber.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['phone']?></p>[PHONE]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['fax'];?></p>[FAX]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['web'];?></p>[WEB]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['zipcode'];?></p>[POST CODE]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['licence_no'];?></p>[TRADE LISCENCE NUMBER]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                ...
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['terms_and_conditions'];?></p>[TERMS AND CONDITIONS]
                                </md-list-item>
                                <md-divider></md-divider>
                                <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['notes'];?></p>[NOTES]
                                </md-list-item>
                                <md-divider></md-divider>
                                ...
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['default_payment_method'];?></p>[DEFAULT PAYMENT METHOD]
                                </md-list-item>
                                <md-divider></md-divider>
                                    <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['creditperiod'];?></p>[CREDIT PERIOD]
                                </md-list-item>
                                <md-divider></md-divider>
                                    <md-list-item>
                                <!--    <md-icon class="mdi mdi-city material-icons"></md-icon> -->
                                <img src="<?php echo base_url('uploads/images/doc_expiry.png') ?>" alt="" width="30"
                                        height="30" /> 
                                    <p ><?php print $customers['creditlimit'];?></p>[CREDIT LIMIT]
                                </md-list-item>
                                <md-divider></md-divider>
                                <?php }?>
...
<div class="main-content container-fluid right-sidebar col-md-3 md-pl-0">
    ...
    <md-content ng-show="!customersLoader" class="bg-white" style="padding: 10px">
...
<md-content ng-if="!contacts.length" class="text-center bg-white"><img width="100%"
    ...
    <md-toolbar class="toolbar-white">
        <div class="md-toolbar-tools">
            <h2 flex md-truncate class="pull-left"><strong><?php echo lang('Documents')?></strong></h2>
...
<md-content  class="text-center bg-white"><img width="100%"
    src="<?php echo base_url('assets/img/add_contact.png') ?>" alt=""></md-content>
<?php }?>
</div>
</div>
...
<md-sidenav class="md-sidenav-right create-form md-whiteframe-4dp" md-component-id="Update" style="width: 450px" ng-cloak>
    <md-toolbar class="toolbar-white">
        <div class="md-toolbar-tools">
            <md-button ng-click="close()" class="md-icon-button" aria-label="Close"> <i
                class="ion-android-arrow-forward"></i> </md-button>

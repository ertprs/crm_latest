          ...
          <table md-table md-progress="promise">
            <thead md-head md-order="projects_list.order">
              <tr md-row>
                ...
                <th ng-show="table_columns.status" md-column md-order-by="progress"><span><?php echo lang('status'); ?>/Date</span></th>
                <th ng-show="table_columns.duration" md-column md-order-by="progress"><span>Duration</span></th>

...
<div class="row">
				 ...
				 <div class="whiteBackGroundESti">
						<div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBackESti">
                         <div class="imgDivMainESti">
						 <div class=" posRESti">
								<div class="dbox__body posAESti"><span class="dbox__title">QUOTE REQUEST</span> </div> 
							</div>
							<div class="percentage numAESti"><?php print $missing;?></div>
							<img src="/uploads/images/icons/red_image.png" class="img-responsive">
							<img src="/uploads/images/icons/tap.png" class="img-responsive imgAnimateESti">
							
								<div class="DotsRightESti">
								  <span class="dot"></span>
								  <span class="dot"></span>
								  <span class="dot"></span>
								  <span class="dot"></span>
				  ...
				  <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBackESti">
                         <div class="imgDivMainESti">
						 <div class=" posRESti">
								<div class="dbox__body posAESti"><span class="dbox__title">DRAFT</br> <!--(Email /Call)--></span> </div> 
							</div>
							<div class="percentage numAESti"><?php print $draft;?></div>
							<img src="/uploads/images/icons/yellow_image.png" class="img-responsive">
							<img src="/uploads/images/icons/phoneLand.png" class="img-responsive imgAnimateESti">
				  ...
				  <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBackESti">
                         <div class="imgDivMainESti">
						 <div class=" posRESti">
								<div class="dbox__body posAESti"><span class="dbox__title">UNDER APPROVAL</span> </div> 
							</div>
							<div class="percentage numAESti"><?php print $underapp;?></div>
							<img src="/uploads/images/icons/brown_image.png" class="img-responsive">
							<img src="/uploads/images/icons/time.png" class="img-responsive imgAnimateESti">
				  ...
				  <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBackESti">
                         <div class="imgDivMainESti">
						 <div class=" posRESti">
								<div class="dbox__body posAESti"><span class="dbox__title">APPROVED</span> </div> 
							</div>
							<div class="percentage numAESti"><?php print $appro;?></div>
							<img src="/uploads/images/icons/green_image.png" class="img-responsive">
							<img src="/uploads/images/icons/thumb.png" class="img-responsive imgAnimateESti">
				   ...
				   <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBackESti">
                         <div class="imgDivMainESti">
						 <div class=" posRESti">
								<div class="dbox__body posAESti"><span class="dbox__title">DECLINED</span> </div> 
							</div>
							<div class="percentage numAESti"><?php print $declined;?></div>
							<img src="/uploads/images/icons/grey_image.png" class="img-responsive">
							<img src="/uploads/images/icons/sad.png" class="img-responsive imgAnimateESti">

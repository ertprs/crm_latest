...
<div class="ciuis-body-content lead-single quote-single" ng-controller="Estimations_Controller">
    ...
    <md-content class="bg-white orders-data">
      <md-tabs md-dynamic-height md-border-bottom>
        <md-tab label="<?php echo 'Estimation'; ?>">
			 ...
			 <div id="details" class="clearfix">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <th class=" unit  text-right">Unit <?php echo lang('price');echo ' (AED)'; ?></th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class=" text-right"><?php echo $main_items['tax'];echo '%'; ?></td>
                      <?php if($disshowhead>0){?>
                       <td class=" unit text-right"><?php echo $main_items['item_discount']; echo '%';?></td>
                       <?php }?>
         ...
         <div class="col-md-12">
          <div class="col-md-8">
                    <div class="text-right text-uppercase text-muted">Total Cost:</div></div><div class="col-md-4 text-left"><?php echo number_format($estimation_record['estimation_total_cost_amt'],2, '.', ',');?></div></div>
           <div class="col-md-12">
          <div class="col-md-8">
                    <div class="text-right text-uppercase text-muted">Estimated Profit:</div></div><div class="col-md-4 text-left"><?php echo number_format($estimation_record['estimation_profit_amt'],2, '.', ',');?></div></div>    
           </div>
                  </div>
				</div>
			<div class="col-md-6 row">
			      <div class="col-md-12">
				  <div class="col-md-8">
                    <div class="text-right text-uppercase text-muted">Total:</div></div><div class="col-md-4 text-right"><?php echo number_format($totalitemprice,2, '.', ',');?></div></div>
                  ...
                  <div class="col-md-12">
				  <div class="col-md-8">
                    <div class="text-right text-uppercase text-muted">Net Total:</div></div><div class="col-md-4 text-right"><?php echo number_format($estimation_record['subtotal_amt'],2, '.', ',');?></div></div>
                    <?php }?>
					  <div class="col-md-12">
				  <div class="col-md-9">
                    <div  class="text-right text-uppercase text-muted">
                    ...
                    <div  class="text-right text-uppercase text-muted">
					  ...
					  <div class="col-md-12 grandtotal-bar">
                    <div class="text-right text-uppercase text-white">
					 <div class="col-md-8"><?php echo lang('grand_total') ?>:</div></div><div class="col-md-4 text-right"><?php echo number_format($estimation_record['estimation_total_amt'],2, '.', ',');?></div></div>
					 </div>
                  </div>
				<hr>
				<?php if($special_notes != '' && $special_notes != null) { ?>
				<h3>Special Notes</h3>

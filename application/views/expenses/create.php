		...
		<md-content ng-show="!expensesLoader" class="bg-white" layout-padding ng-cloak>
			<div layout-gt-xs="row">
				...
				<md-input-container class="md-block">
					...
					<input mdc-datetime-picker="" date="true" time="false" type="text" id="created" placeholder="<?php echo lang('date') ?>" required show-todays-date="" minutes="true" min-date="date" show-icon="true" ng-model="newexpense.date"  name="created"  class=" dtp-no-msclear dtp-input md-input" >
				</md-input-container>
				<md-input-container class="md-block" flex-gt-xs>
		...
		<md-toolbar class="toolbar-white">
			<div class="col-sm-12 files">
				<h2 flex style="margin-top: 9px;">
					...
					<?php echo lang('files') ?>
					<a href="javascript:void(0)" class="pull-right file_upload_btn"><i class="fa fa-plus"></i></a>
				</h2>
				<div class="file_upload" style="display: none;">
					<input type="file" required name="file_name[]"  class="form-control"  multiple>

  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9" ng-cloak>
    ...
    <md-toolbar ng-show="!expensesLoader" class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><span ng-bind="expense.longid"></span></h2>
    ...
    <md-content ng-show="!expensesLoader" class="bg-white" layout-padding>
      <div layout-gt-xs="row">
       ...
       <!--- <md-input-container class="md-block" flex-gt-xs ng-show="!expense.internal">
          ...
          <md-select required placeholder="<?php echo lang('choisecustomer'); ?>" ng-model="expense.customer" name="customer" style="min-width: 200px;" data-md-container-class="selectdemoSelectHeader">
		...
		<md-input-container class="md-block">
			...
			<input mdc-datetime-picker="" date="true" time="false" type="text" id="datetime" placeholder="<?php echo lang('date') ?>" required show-todays-date="" minutes="true" min-date="date"show-icon="true" ng-model="expense.date_edit"  name="created"  class=" dtp-no-msclear dtp-input md-input">
		</md-input-container>
		 <md-input-container class="md-block" flex-gt-xs>
        ...
        <br>
	  	...
	  	<div layout-gt-xs="row">
			<div class="col-sm-3" >
			<label class="radio-inline"><input type="radio" name="Cash"  value="1"  ng-model="expense.amountType" ng-click="setvalue(1)" ng-selected="expense.amountType==1">Cash</label>
			<label class="radio-inline"><input type="radio" name="Card" value="2"  ng-model="expense.amountType" ng-click="setvalue(2)" ng-selected="expense.amountType==2">Card</label>
			</div>
			<div class="col-sm-6" ng-show="expense.amountType==1">
				<md-input-container class="md-block" flex-gt-xs style="margin-top: -11px;">
				<label><?php echo lang('Select Cash Account'); ?></label>
					<md-select  ng-model="expense.account" name="account" style="min-width: 200px;">
						<md-option ng-value="account.id" ng-repeat="account in accounts">{{account.name}}</md-option>
					</md-select>
				</md-input-container>
			</div>
			<div class="col-sm-6" ng-show="expense.amountType==2">
				<md-input-container class="md-block" flex-gt-xs style="margin-top: -11px;">
					<label><?php echo lang('Select Card'); ?></label>
					<md-select  ng-model="expense.card" name="card" style="min-width: 200px;">
						<md-option ></md-option>
					</md-select>
				</md-input-container>
			</div><br>
      ...
      <div ng-show="expense.recurring_status" layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="date" name="EndRecurring" ng-model="expense.EndRecurring" style="min-width: 100%;" md-open-on-focus></md-datepicker>
          <div >
      ...
      <md-list-item ng-repeat="item in expense.items">
        <div layout-gt-sm="row">
          ...
          <md-input-container class="md-block">
            ...
            <bind-expression ng-init="selectedProduct.cost = item.price" expression="selectedProduct.cost" ng-model="item.price" />
          </md-input-container>
			<md-input-container class="md-block">
			<label><?php echo lang('account'); ?></label>
			<input class="min_input_width" ng-model="item.account">
			<bind-expression ng-init="selectedProduct.account = item.account" expression="selectedProduct.account" ng-model="item.account" />
			</md-input-container>
          <md-input-container class="md-block" flex-gt-sm>

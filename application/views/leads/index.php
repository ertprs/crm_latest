...
<div class="ciuis-body-content leads-page" ng-controller="Leads_Controller" >
  ...
  <div class="row">
          ...
          <div class="md-toolbar-tools">
            ...
            <div class="ciuis-external-search-in-table table-search" ng-cloak>
              ...
              <md-button class="md-icon-button" aria-label="Search">
                <md-icon aria-label="Add Source"><ion-icon name="search-outline"></ion-icon></md-icon>
            ...
            <md-button ng-click="LeadSettings()" class="md-icon-button" aria-label="Settings" ng-cloak>
              ...
              <md-icon aria-label="Add"><ion-icon name="cog-outline"></ion-icon></md-icon>
            </md-button>
            <md-button ng-if="!KanbanBoard" ng-click="ShowKanban()" class="md-icon-button" aria-label="Show Kanban" ng-cloak>
              ...
              <md-icon aria-label="Add Source"><ion-icon name="grid-outline"></ion-icon></md-icon>
            </md-button>
            <md-button ng-if="KanbanBoard" ng-click="HideKanban()" class="md-icon-button" aria-label="Show List" ng-cloak>
              ...
              <md-icon aria-label="Add Source"><ion-icon name="list-outline"></ion-icon></md-icon>
            </md-button>
            <md-button ng-click="toggleFilter()" class="md-icon-button" aria-label="Filter" ng-cloak>
              ...
              <md-icon aria-label="Add Source"><ion-icon name="filter-circle-outline"></ion-icon></md-icon>
            </md-button>
            <?php if (check_privilege('leads', 'create')) { ?> 
              <md-button ng-click="Create()" class="md-icon-button" aria-label="New" ng-cloak>
                ...
                <md-icon aria-label="Add Source"><ion-icon name="add-circle"></ion-icon></md-icon>
              </md-button>
            <?php } ?>
            <md-menu md-position-mode="target-right target" ng-cloak>
              <md-button aria-label="Open demo menu" class="md-icon-button" ng-click="$mdMenu.open($event)">
                <md-icon aria-label="Add Source"><ion-icon name="ellipsis-vertical-outline"></ion-icon></md-icon>
              </md-button>
    ...
    <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12" ng-cloak>
      ...
      <div class="widget-chart-container" style="margin-bottom: 0px; padding-bottom: 5px;box-shadow: 4px 4px 10px 0 rgba(0, 0, 0, 0.1), 4px 4px 15px -5px rgb(58 65 81 / 0.4)">
      ...
      <div class="widget-chart-container" style="margin-bottom: 0px; padding-bottom: 5px;box-shadow: 4px 4px 10px 0 rgba(0, 0, 0, 0.1), 4px 4px 15px -5px rgb(58 65 81 / 0.4);"> 
       ...
       <md-toolbar class="toolbar-white sidebar-left">
              <div class="md-toolbar-tools"> 
                <h2 class="md-pl-10" flex md-truncate><?php echo 'Leads By Days';?></h2>
              </div>
            </md-toolbar>
      <md-content class="bg-black sidebar-left">
              <md-list flex class="md-p-0 sm-p-0 lg-p-0" ng-cloak>
                <md-list-item ng-click="GetLeads('All');changeColor('all');removeassigned();get_leads_count_by_staff_days();" class="">
                  <p class="leadbytype_all alldaysCls"><span>»</span> <strong>All</strong></p>
                </md-list-item>
                <md-list-item ng-click="GetLeads('today');changeColor('today');removeassigned();get_leads_count_by_staff_days();" class="">
                  <p class="leadbytype_today alldaysCls"><span>»</span> <strong>Today</strong></p>
                </md-list-item>
                <md-list-item ng-click="GetLeads('yesterday');changeColor('yesterday');removeassigned();get_leads_count_by_staff_days();" class="">
                  <p class="leadbytype_yesterday alldaysCls"><span>»</span> <strong>Yesterday</strong></p>
                </md-list-item>
                <md-list-item ng-click="GetLeads('lastweek');changeColor('lastweek');removeassigned();get_leads_count_by_staff_days();" class="">
                  <p class="leadbytype_lastweek alldaysCls"><span>»</span> <strong>Last Week</strong></p>
                </md-list-item>
                <md-list-item ng-click="GetLeads('lastmonth');changeColor('lastmonth');removeassigned();get_leads_count_by_staff_days();" class="">
                  <p class="leadbytype_lastmonth alldaysCls"><span>»</span> <strong>This Month</strong></p>
                </md-list-item>
              </md-list>
            </md-content>
      <md-toolbar class="toolbar-white sidebar-left">
            ...
            <md-content class="bg-white">
        <md-list-item ng-repeat="sales in all_sales_staff" class="noright" aria-label="Edit Status" style="padding-left:16px;">
                 ...
                 <div class="col-md-12">
                      ...
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBack">
                         <div class="imgDivMain">
							...
							<div class="percentage numA" ng-bind="openLeads" ng-click="GetTableData('Filter by Status','Open');"><?= $openLeads['total']; ?>
							</div>
								<div class="DotsRight">
								  <span class="dot"></span>
								  <span class="dot"></span>
				  ...
				  <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBack">
                         <div class="imgDivMain">
							<img src="/uploads/images/icons/yellow_image.png" class="img-responsive">
							<img src="/uploads/images/icons/phoneLand.png" class="img-responsive imgAnimate">
							<div class=" posR">
								<div class="dbox__body posA"><span class="dbox__title">FOLLOW UP</br> <!--(Email /Call)--></span> </div> 
							</div>
							<div class="percentage numA"  ng-bind="ecfollowupLeads" ng-click="GetTableData('Filter by Status','FOLLOW UP (Email /Call)');"><?= $ecfollowupLeads['total']; ?></div>
							<div class="DotsRight">
								  <span class="dot"></span>
								  <span class="dot"></span>
								  <span class="dot"></span>
				  ...
				  <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBack">
                         <div class="imgDivMain">
							<img src="/uploads/images/icons/brown_image.png" class="img-responsive">
							<img src="/uploads/images/icons/time.png" class="img-responsive imgAnimate">
							<div class=" posR">
								<div class="dbox__body posA"><span class="dbox__title">CHASE</span> </div> 
							</div>
							<div class="percentage numA" ng-click="GetTableData('Filter by Status','Chase');" ng-bind="chaseLeads"><?= $chaseLeads['total']; ?></div>
							<div class="DotsRight">
								  <span class="dot"></span>
								  <span class="dot"></span>
								  <span class="dot"></span>
				  ...
				  <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBack">
                         <div class="imgDivMain">
							<img src="/uploads/images/icons/green_image.png" class="img-responsive">
							<img src="/uploads/images/icons/thumb.png" class="img-responsive imgAnimate">
							<div class=" posR">
								<div class="dbox__body posA"><span class="dbox__title">Converted</span> </div> 
							</div>
							<div class="percentage numA" ng-click="GetTableData('Filter by Status','Converted');" ng-bind="convertedLeads"><?= $convertedLeads['total']; ?></div>
							<div class="DotsRight">
								  <span class="dot"></span>
								  <span class="dot"></span>
								  <span class="dot"></span>
				   ...
				   <div class="round-boxes">
                      <!--- <div class="box-header text-uppercase text-bold">Open</div>--->
                       <div class="box-content custom-icon whiteBack">
                         <div class="imgDivMain">
							<img src="/uploads/images/icons/grey_image.png" class="img-responsive">
							<img src="/uploads/images/icons/sad.png" class="img-responsive imgAnimate">
							<div class=" posR">
								<div class="dbox__body posA"><span class="dbox__title">Lost</span> </div> 
							</div>
							<div class="percentage numA" ng-click="GetTableData('Filter by Status','Lost');" ng-bind="lostfollowupLeads"><?= $lostfollowupLeads['total']; ?></div>
						   </div>
						</div>
                  </div>
					</div>
...
<circle class="js-circle circle" cx="50" cy="50" r="48" stroke="#e4e7ea" stroke-width="4" fill="none"></circle>
            ...
            <!-- <a href="#" class="text-center">View</a> --
                    <div class="round-boxes">
              ...
              <img src="/crm/uploads/images/icons/icon2.jpeg" width="100%">
            </div>
            </div>
<div class="anim-circle">
    <svg width="140px" height="140px" viewBox="0 0 100 100" preserveAspectRatio="none">
...
<circle class="js-circle circle" cx="50" cy="50" r="48" stroke="#e4e7ea" stroke-width="4" fill="none"></circle>
            ...
            <div class="percentage" ng-click="GetTableData('Filter by Status','Chase');" ng-bind="chaseLeads"><?= $chaseLeads['total']; ?></div>
              ...
              <!-- <div class="dbox__icon">    
                <div class="progress yellow">
                  <img src="https://cdn.dribbble.com/users/39201/screenshots/3694057/nutmeg.gif" width="50">
            ...
            <img src="/crm/uploads/images/icons/icon3.jpeg" width="100%">
          </div>
          </div>
<div class="anim-circle">
    <svg width="140px" height="140px" viewBox="0 0 100 100" preserveAspectRatio="none">
...
<circle class="js-circle circle" cx="50" cy="50" r="48" stroke="#e4e7ea" stroke-width="4" fill="none"></circle>
        ...
        <md-content class="md-pt-0" ng-cloak>
          ...
          <td md-cell>
            ...
            <span ng-show="lead.date_assigned_time != ''" class="badge" ng-bind="lead.date_assigned_time"></span>
                    ...
                    <td md-cell>
                      <strong>
                        <span ng-if="lead.statusname == 'Lost'" class="badge status proposal-status-declined" ng-bind="lead.statusname">
                        </span>
                        <span ng-if="lead.statusname == 'Converted'" class="badge status proposal-status-approved" ng-bind="lead.statusname">
                        </span>
                        <span ng-if="lead.statusname == 'FOLLOW UP (Email /Call)'" class="badge status proposal-status-accepted" ng-bind="lead.statusname">
                        </span>
                        <span ng-if="lead.statusname == 'Open'" class="badge status proposal-status-open" ng-bind="lead.statusname">
                        </span>
                        <span ng-if="lead.statusname == 'Chase'" class="badge status chase" ng-bind="lead.statusname">
                        </span>
                      </strong>
                    </td>
                    <td md-cell>
    ...
    <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="LeadsSettings" ng-cloak style="width: 450px;">
      ...
      <md-content>
        <md-toolbar class="toolbar-white" style="background:#262626">
          <div class="md-toolbar-tools second-heading">

...
<div class="ciuis-body-content lead-single" ng-controller="Lead_Controller">
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    <md-toolbar class="toolbar-white lead-user">
      <div class="md-toolbar-tools">
        ...
        <strong style="margin-top:4%;margin-left:-70px" flex md-truncate ng-bind="lead.name"></strong>
    ...
    <md-content ng-show="!leadsLoader" class="bg-white orders-data" ng-cloak>
            ...
            <md-content class="bg-white" flex="50">
              <md-list flex class="md-p-0 sm-p-0 lg-p-0">
                <md-list-item class="marginBtm">
                  ...
                  <strong flex md-truncate><span class="width15"><?php echo lang('title') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.title"></p>
                </md-list-item>
                <!--<md-divider></md-divider>-->
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-nature-people iconSet"></md-icon>
                  <strong flex md-truncate><span class="width15"><?php echo lang('status') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.status"></p>
                </md-list-item>
                 <!--<md-divider></md-divider>-->
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-local-phone iconSet"></md-icon>
                  <strong flex md-truncate><span class="width15"><?php echo lang('phone') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.phone"></p>
                </md-list-item>
                 <!--<md-divider></md-divider>-->
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-markunread-mailbox iconSet"></md-icon>
                  <strong flex md-truncate><span class="width22"><?php echo lang('zip') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.zip"></p>
                </md-list-item>
                 <!--<md-divider></md-divider>-->
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-map iconSet"></md-icon>
                  <strong flex md-truncate><span class="width15"><?php echo lang('state') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.state"></p>
                </md-list-item>
                <!--<md-divider></md-divider>-->
                <!--<md-list-item>
                  <md-icon class="mdi mdi-http"></md-icon>
                  <strong flex md-truncate><span><?php echo lang('web') ?></span></strong>
                  <p class="text-right" flex md-truncate ng-bind="lead.website"></p>
                </md-list-item>-->
					<md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-assignment-account iconSet"></md-icon>
                  <strong flex md-truncate><span class="width22"><?php echo lang('assigned') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.assigned"></p>
                </md-list-item>
                <md-list-item class="marginBtm">
                  <md-icon class="mdi ion-android-calendar iconSet"></md-icon>
                  <strong flex md-truncate><span class="width32"><?php echo lang('created_date') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.created"></p>
                </md-list-item>
            <md-list-item class="marginBtm">
              <md-icon class="mdi mdi-pin-drop iconSet"></md-icon>
              <strong flex md-truncate><span class="width22"><?php echo lang('address') ?></span></strong>
              <p class="text-right positionA" flex ng-bind="lead.address"></p>
            </md-list-item>
			<md-list-item class="marginBtm">
              <md-icon class="mdi mdi-sort-desc iconSet"></md-icon>
			   <strong flex md-truncate><span class="width22"><?php echo lang('description') ?></span></strong>
              <p class="text-left positionA" flex ng-bind="lead.description"></p>
            </md-list-item>
              </md-list>
            </md-content>
            <md-content class="bg-white leads-view-right" flex="50">
              <md-list flex class="md-p-0 sm-p-0 lg-p-0">
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-local-store iconSet"></md-icon>
                  <strong flex md-truncate><span class="width32"><?php echo lang('company') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.company"></p>
                </md-list-item>
                <md-list-item class="marginBtm">
                  <md-icon class="mdi ion-android-mail iconSet"></md-icon>
                  <strong flex md-truncate><span class="width15"><?php echo lang('email') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.email"></p>
                </md-list-item>
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-local-phone iconSet"></md-icon>
                  <strong flex md-truncate><span class="width15"><?php echo lang('Mobile') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.mobile"></p>
                </md-list-item>
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-city iconSet"></md-icon>
                  <strong flex md-truncate><span class="width15"><?php echo lang('city') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.city"></p>
                </md-list-item>
                <md-list-item class="marginBtm">
                  <md-icon class="mdi ion-earth iconSet"></md-icon>
                  <strong flex md-truncate><span class="width22"><?php echo lang('country') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.country"></p>
                </md-list-item>
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-book-image iconSet"></md-icon>
                  <strong flex md-truncate><span class="width15"><?php echo lang('source') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.source"></p>
                </md-list-item>
                <md-list-item class="marginBtm">
                  <md-icon class="mdi mdi-book-image iconSet"></md-icon>
                  <strong flex md-truncate><span class="width32"><?php echo lang('lastupdate') ?></span></strong>
                  <p class="text-right positionA" flex md-truncate ng-bind="lead.dateassigned"></p>
                </md-list-item>
              </md-list>
            </md-content>
          </div>

			...
			<div class="row">
				...
				                </select>
							...
							<div class="col-md-3" align="center">
								...
								<select class="form-control unitType" name="unit_type" id="unit_type" required>
								<option value="">Select Unit Type</option>
									<?php foreach($unittypes as $eachunittype) { 
										echo "<option value=".$eachunittype['unit_name'].">".$eachunittype['unit_name']."</option>";
									}
									?>
								</select>
								<!--
...
$(".matNameChange,.unitType").select2({
	theme: "bootstrap",
	tags: true,
...
$('.matNameChange').on('change', function() {
    ...
    $('#unit_type').select2({	theme: "bootstrap",
	tags: true,
	createTag: function (params) {
    var term = $.trim(params.term);

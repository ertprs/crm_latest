...
<?php $checked = ''; if($notebooks->note_type == 'on') { 

$checked = "checked"; } else { 
$chceked = '';

 } ?>
    <input type="checkbox" id="switch" name="others" <?php echo $checked;?> onclick="select_status(this.value,<?php echo $notebooks->notebook_id;?>)" >
    ...
    function select_status(val,id){
       if ($('#switch').is(':checked')) {
           var switch_val = 'on';
       	 ...
       	 $.ajax({
              url : "<?php echo base_url(); ?>notebooks/update_type",
              data:{switch_val : switch_val, id : id},
              method:'POST',
              dataType:'json',
              success:function(response) {
				window.location.href="<?php echo base_url(); ?>notebooks/view/"+id;

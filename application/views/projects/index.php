          ...
          <table md-table  md-progress="promise">
            <thead md-head md-order="projects_list.order">
              <tr md-row>
                ...
                <th ng-show="table_columns.value" md-column><span><?php echo lang('value'); echo ' (AED)' ?></span></th>
            ...
            <tbody md-body>
              <tr class="select_row" md-row ng-repeat="project in projects | orderBy: projects_list.order | filter: project_search | limitTo: projects_list.limit : (projects_list.page -1) * projects_list.limit | filter: FilteredData">
                <td md-cell>
                  <strong>
                ...
                <td md-cell ng-show="table_columns.value">
                  <span ng-bind="project.value"></span>
                </td>
                <td md-cell ng-show="table_columns.status">
                  <div class="progress-widget">
					...
					<div ng-show="project.status_class == 'started'" class="progress" style="height: 7px">
					 ...
					 <span ng-show="project.status_class == 'started'" ng-bind="project.percentage_completed+'%'"></span>
					 <span ng-show="project.status_class != 'cancelled' && project.status_class != 'started'" ng-bind="project.progress+'%'"></span>
					 <span class="ciuis-task-percent-bg" >
						<span class="ciuis-task-percent-fg" ng-show="project.status_class == 'started'" style="width:{{project.percentage_completed+'%'}}" class="progress-value"></span>
						<div ng-show="project.status_class != 'cancelled' && project.status_class != 'started'">
							<span class="ciuis-task-percent-fg progress-bar-primary" ng-hide="project.progress == 100 || project.progress == 0" style="width:{{project.progress+'%'}}"></span>
							<span class="ciuis-task-percent-fg progress-bar-success" ng-show="project.progress == 100" style="width:{{project.progress+'%'}}"></span>
							<span class="ciuis-task-percent-rg progress-bar-danger" ng-show="project.progress == 0" style="width:{{'100%'}}"></span>
						</div>
						<div ng-hide="project.status_class == 'started'">
							<span class="ciuis-task-percent-fg progress-bar-primary" ng-hide="project.percentage_completed == 100" style="width:{{project.percentage_completed+'%'}}" class="progress-bar-primary"></span>
							<span class="ciuis-task-percent-fg progress-bar-success" ng-show="project.percentage_completed == 100" style="width:{{project.percentage_completed+'%'}}" class="progress-bar-success"></span>
						</div>
					 </span>
        ...
        <div class="panel-default">
          ...
          <div class="panel-body" style="padding: 0px;">
            <div class="project-stats-body pull-left">
			  ...
			  <span class="ciuis-task-percent-bg" style="width:100%;">
				<span class="ciuis-task-percent-fg" style="width: {{stats.not_started_percent}}%;"></span>
			  </span>
            </div>
            <!--<div class="project-stats-body pull-left">

          ...
          <div layout="row" layout-wrap>
            ...
            <div flex-sm="33" flex-xs="50" flex-lg="16" flex-gt-sm="16" class="text-center">
				...
				<div ng-hide="project.status_class == 'cancelled' || project.status_class == 'started'" class="progress" style="height: 7px">
				  <div ng-hide="project.progress == 100 || project.progress == 0" style="width: {{project.progress}}%;" class="progress-bar progress-bar-primary"></div>
				  <div ng-show="project.progress == 100" style="width: {{project.progress}}%;" class="progress-bar progress-bar-success"></div>
				  <div ng-show="project.progress == 0" style="width: 100%;" class="progress-bar progress-bar-danger"></div>
                </div>
      ...
      <md-list flex ng-cloak>
        <md-list-item class="md-2-line" ng-repeat="file in files | pagination : currentPage*itemsPerPage | limitTo: 6">
          <div class="md-list-item-text image-preview">
			...
			<a ng-if="file.type == 'pdf'" ng-click="ViewPdfFile(file.id,file.path)" class="cursor">
              <md-tooltip md-direction="left"><?php echo lang('preview') ?></md-tooltip>
              <img src="<?php echo base_url('assets/img/pdf_icon.png');?>">
            </a>
          </div>

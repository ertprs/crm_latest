...
<div class="ciuis-body-content" ng-controller="Purchases_Controller">
	...
	<md-content class="bg-white" layout-padding ng-cloak>
		<div layout-gt-xs="row">
          ...
          <md-select required placeholder="<?php echo lang('vendor'); ?>" 
             ng-model="vendor" name="vendor" style="min-width: 200px;" ng-change="Getvendordata(vendor)" >
            <md-select-header>
              <md-toolbar class="toolbar-white">
                <div class="md-toolbar-tools">
                  <md-button class="md-icon-button" aria-label="Invoice" ng-disabled="true">
		...
		<md-input-container class="md-block">
			...
			<input mdc-datetime-picker="" date="true" time="false" type="text" id="datetime" placeholder="<?php echo lang('dateofissuance') ?>" required show-todays-date="" minutes="true" min-date="date"show-icon="true" ng-model="created"  name="created"  class=" dtp-no-msclear dtp-input md-input" ng-init="created=date">
		</md-input-container>
          <!--- <md-input-container>
            <label><?php echo lang('dateofissuance') ?></label>
        ...
        <div ng-show="purchase_status" layout-gt-xs="row">
		  ...
		  <md-input-container class="md-block">
			...
			<input mdc-datetime-picker="" date="true" time="false" type="text" id="datepayment" placeholder="<?php echo lang('datepaid') ?>" required show-todays-date="" minutes="true" min-date="date" show-icon="true" ng-model="datepayment"  name="datepayment"  class=" dtp-no-msclear dtp-input md-input" >
		</md-input-container>
          <md-input-container>
            <label><?php echo lang('datepaid') ?></label>
        ...
        <div ng-show="!purchase_status" layout-gt-xs="row">
          <md-input-container class="md-block" flex-gt-sm>
		   ...
		   <md-input-container class="md-block">
			 <label><?php echo lang('datepaid') ?></label>
			<input mdc-datetime-picker="" date="true" time="false" type="text" id="datepayment" placeholder="<?php echo lang('datepaid') ?>" required show-todays-date="" minutes="true" min-date="created" show-icon="true" ng-model="duedate"  name="duedate"  class=" dtp-no-msclear dtp-input md-input" >
		</md-input-container>
	...
	<md-list-item ng-repeat="item in purchase.items">
		<div layout-gt-sm="row">
			...
			<strong ng-bind-html="product.cost | currencyFormat:cur_code:null:true:cur_lct"></strong>
			</md-item-template>
		</md-autocomplete>
		<md-input-container class="md-block">
		...
		<md-input-container class="md-block" flex-gt-xs>
			...
			<input class="min_input_width" ng-model="item.tax" placeholder="%">

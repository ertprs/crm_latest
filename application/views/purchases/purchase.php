    ...
    <md-content ng-show="!purchaseLoader" class="bg-white invoice" ng-cloak>
      <div class="invoice-header col-md-12">
        ...
        <div class="invoice-date col-md-4 col-xs-12">
          <label ><b style="font-size:15px;">date of issurance:</b> {{purchase.created }}</label>
		   <label ><b style="font-size:15px;">date of Paid:</b> {{purchase.duedate }}</label>
      ...
      <div class="invoice-content col-md-12 md-p-0 xs-p-0 sm-p-0 lg-p-0">
        ...
        <div class="invoice-price-right">
			<div class="col-sm-12 pull-right"><label  class="col-sm-10"><b><?php echo lang('subtotal') ?></b></label>  <label class="col-sm-2" ng-bind-html="purchase.sub_total | currencyFormat:cur_code:null:true:cur_lct"></label></div>
           <div class="col-sm-12 pull-right"> <label  class="col-sm-10"><b><?php echo lang('tax') ?></b></label>  <label class="col-sm-2" ng-bind-html="purchase.total_tax | currencyFormat:cur_code:null:true:cur_lct"></label></div>  
			 <div class="col-sm-12 pull-right"> <label class="col-sm-10"><b><?php echo lang('discount') ?></b></label>   <label class="col-sm-2" ng-bind-html="purchase.total_discount | currencyFormat:cur_code:null:true:cur_lct"></label></div>
            <div class="col-sm-12 pull-right"> <label class="col-sm-10"><b><?php echo lang('total') ?></b></label>    <label class="col-sm-2" ng-bind-html="purchase.total | currencyFormat:cur_code:null:true:cur_lct"></label></div>
		</div>

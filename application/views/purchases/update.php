		...
		<md-content ng-show="!purchaseLoader" class="bg-white" layout-padding ng-cloak>
			<div layout-gt-xs="row">
				...
				<md-input-container class="md-block" flex-gt-xs>
					...
					<md-select required placeholder="<?php echo lang('choisevendor'); ?>" ng-model="purchase.vendor" name="vendor" style="min-width: 200px;" ng-change="Getvendordata(vendor)">
				...
				<md-input-container class="md-block">
					...
					<input mdc-datetime-picker="" date="true" time="false" type="text" id="datetime" placeholder="<?php echo lang('dateofissuance') ?>" required show-todays-date="" minutes="true" min-date="date"show-icon="true" ng-model="purchase.created_edit"  name="created"  class=" dtp-no-msclear dtp-input md-input">
				</md-input-container>
				<!---<md-input-container>
					<label><?php echo lang('dateofissuance') ?></label>
			...
			<div ng-show="purchase.status_id != '2'" layout-gt-xs="row">
				...
				<md-input-container class="md-block">
					...
					<input mdc-datetime-picker="" date="true" time="false" type="text" id="datepayment" placeholder="<?php echo lang('datepaid') ?>" required show-todays-date="" minutes="true" min-date="created" show-icon="true" ng-model="purchase.duedate_edit"  name="duedate"  class=" dtp-no-msclear dtp-input md-input" >
				</md-input-container>
				<!---<md-input-container>

					...
					<md-tab label="<?php echo lang('documents');?>">
						...
						<div>
							<form  action="<?php echo base_url('staff/update_documents/'.$staffres['id']);?>" method="post" enctype="multipart/form-data">
								...
								if(check_privilege('userdocuments', 'all')) { 
									    	$disabled = 'disabled';
									    	}  
									    	
									    	?>
									    	<?php 	  ?>
										<label for="inputState" class="col-md-12"><span id="headname<?php print $docmenu[0]->doc_id;?>"><?php print $docmenu[0]->doc_heading;?></span> <?php if(check_privilege('userdocuments', 'edit')) { if (isAdmin()) {?><a  onclick="showmodalpop('<?php print $docmenu[0]->doc_id;?>')" href="javascript:void(0)" class="text-danger float-right"><i class="glyphicon glyphicon-edit"></i></a><?php } }?></label>
										<?php   ?>
										<input type="text" class="form-control" name="passport" id="inputZip" <?php echo $disabled; ?> value="<?php echo @$documents->passport; ?>"  >
									</div>
									...
									<div class="form-group col-md-2">
										...
										<?php 	if(check_privilege('userdocuments', 'edit')) {  ?>
									<div class="form-group col-md-2">
								...
								<div class="form-row col-md-12 row">
									<div class="form-group col-md-3">
										...
										<label for="inputState" class="col-md-12"><span id="headname<?php print $docmenu[1]->doc_id;?>"><?php print $docmenu[1]->doc_heading;?></span><?php 	if(check_privilege('userdocuments', 'edit')) {  ?><?php if (isAdmin()) {?><a  onclick="showmodalpop('<?php print $docmenu[1]->doc_id;?>')" href="javascript:void(0)" class="text-danger float-right"><i class="glyphicon glyphicon-edit"></i></a><?php }?><?php } ?></label>
								...
								<div class="form-row col-md-12 row">
									<div class="form-group col-md-3">
										...
										<label for="inputState" class="col-md-12"><span id="headname<?php print $docmenu[2]->doc_id;?>"><?php print $docmenu[2]->doc_heading;?></span> <?php 	if(check_privilege('userdocuments', 'edit')) {  ?><?php if (isAdmin()) {?><a  onclick="showmodalpop('<?php print $docmenu[2]->doc_id;?>')" href="javascript:void(0)" class="text-danger float-right"><i class="glyphicon glyphicon-edit"></i></a><?php }?><?php } ?></label>
								...
								<div class="form-row col-md-12 row">
									<div class="form-group col-md-3">
										...
										<label for="inputState" class="col-md-12"><span id="headname<?php print $docmenu[3]->doc_id;?>"><?php print $docmenu[3]->doc_heading;?></span><?php 	if(check_privilege('userdocuments', 'edit')) {  ?><?php if (isAdmin()) {?><a  onclick="showmodalpop('<?php print $docmenu[3]->doc_id;?>')" href="javascript:void(0)" class="text-danger float-right"><i class="glyphicon glyphicon-edit"></i></a><?php }?><?php } ?></label>
								...
								<div class="form-row col-md-12 row">
									<?php if(count($otherdoc) == 0){ ?>
										...
										<div class="form-group col-md-3">
											...
											<label for="inputState" class="col-md-12"><span id="headname<?php print $docmenu[4]->doc_id;?>"><?php print $docmenu[4]->doc_heading;?></span><?php 	if(check_privilege('userdocuments', 'edit')) {  ?><?php if (isAdmin()) {?><a  onclick="showmodalpop('<?php print $docmenu[4]->doc_id;?>')" href="javascript:void(0)" class="text-danger float-right"><i class="glyphicon glyphicon-edit"></i></a><?php }?><?php } ?></label>
													...
													foreach ($others_doc as $key => $pass_value) {
														if($pass_value != '') {  
															...
															<div class="row">
																...
																<?php if (check_privilege('userdocuments', 'delete')) { ?>
								...
								<?php 	if(check_privilege('userdocuments', 'create')) {  ?>
								<div class="col-md-12">
					...
					<md-tab label="<?php echo lang('assets');?>">
						...
						<?php  if (check_privilege('tools', 'create')) { ?>
							<div class="col-md-12 row">
								...
								<select name="approved_by" required=""  class="form-control" >
								<option value="0">Select </option>
								<?php 
									foreach($staffdetails as $eachstaff){
									?>
								<option value="<?php print $eachstaff['staffname'];?>"><?php print $eachstaff['staffname'];?></option>
								<?php }?>
								</select>
								<?php }?>

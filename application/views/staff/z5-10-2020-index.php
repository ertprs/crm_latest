			...
			<md-content class="bg-white" >
				<md-list flex class="md-p-0 sm-p-0 lg-p-0" ng-cloak>
					<md-list-item ng-repeat="department in departments" ng-click="EditDepartment($index)" aria-label="Project">
						...
						<?php } ?>						<md-button ng-click="LockDepartment($index)" class="md-icon-button" aria-label="Create">
							  <md-tooltip md-direction="bottom">Block</md-tooltip>
							  <md-icon><i class="ion-locked text-muted"></i></md-icon>
							</md-button>

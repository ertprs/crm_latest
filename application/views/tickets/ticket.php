				...
				<?php } if (check_privilege('tickets', 'edit')) { ?> 
					<md-menu md-position-mode="target-right target" ng-cloak>
						...
						<md-menu-content width="4">
							...
							<md-menu-item>
								<md-button ng-click="MarkAs(4,lang.closed)" ng-bind="lang.markascomplete" aria-label="Completed"></md-button>
							</md-menu-item>
						</md-menu-content>
					</md-menu>
				<?php } ?>
	...
	<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-3 md-pl-0">
		...
		<div ng-show="documentFiles" layout-align="center center" class="text-center" id="circular_loader">
			...
			<p style="font-size: 15px;margin-bottom: 5%;">
				...
				<small><strong><?php echo lang('loading'). ' Task Files...' ?></strong></small></span>
			</p>
		</div>
		<md-content class="bg-white" ng-show="!documentFiles">
			 <md-list-item class="md-2-line" ng-show="files1">
				<div class="md-list-item-text image-preview" ng-show="files1">
					<a ng-if="filetype == 'jpg'|| filetype == 'jpeg'|| filetype == 'png'|| filetype =='gif'|| filetype =='bmp'" class="cursor" ng-click="ViewPdfFiledoc('<?php echo $ticket['id'];?>','<?php echo $ticket["attachment"]  ?>')">
					  <md-tooltip md-direction="left"><?php echo lang('preview') ?></md-tooltip>
					  <img src="<?php echo base_url();?>uploads/attachments/<?php echo $ticket["attachment"];  ?>">
					</a>
					<a ng-if="(filetype == 'archive')" class="cursor" ng-href="<?php echo base_url('tickets/attachments/'.$ticket["attachment"]);?>">
					  <md-tooltip md-direction="left"><?php echo lang('download') ?></md-tooltip>
					  <img src="<?php echo base_url('assets/img/zip_icon.png');?>">
					</a>
					<a ng-if="(filetype == 'file')" class="cursor" ng-href="<?php echo base_url('tickets/attachments/'.$ticket["attachment"]);?>">
					  <md-tooltip md-direction="left"><?php echo lang('download') ?></md-tooltip>
					  <img src="<?php echo base_url('assets/img/file_icon.png');?>">
					</a>
					<a ng-if="filetype == 'pdf'" class="cursor" ng-click="ViewPdfFiledoc('<?php echo $ticket['id'];?>','<?php echo $ticket["attachment"]  ?>')">
				...
				<div class="md-list-item-text">
					<a  class="cursor" ng-click="ViewPdfFiledoc('<?php echo $ticket['id'];?>','<?php echo $ticket["attachment"]  ?>')"><h3 class="link">{{files1}}</h3></a>
				</div>
...
<script>
	...
	var files1='<?php echo $ticket["attachment"]  ?>';	
	var file_type = files1.split('.');
</script>

			...
			<md-sidenav class="md-sidenav-left" md-component-id="left" md-is-locked-open="$mdMedia('gt-md')" style="z-index:0" ng-cloak>
				...
				<md-content class="bg-white" style="border-right:1px solid #e0e0e0;">
					<md-list flex class="md-p-0 sm-p-0 lg-p-0">
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[VENDOR NAME]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[COMPANY ADDRESS]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
						...
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[CONTACT PERSON(ACCOUNTS)]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[VAT OFFICE]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[VAT NUMBER]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[VENDOR AUTHORITY]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[MOBILE NUMBER]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[CREDIT PERIOD]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[CREDIT LIMIT]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[FAX]
						</md-list-item>
						<md-divider></md-divider>
						<md-list-item>
							<img src="<?php echo base_url('uploads/images/contact_number_office.png') ?>" alt="" width="30" height="30" /> 
							<p ><?php print $vendors['contact_number']?></p>[EMAIL]
						</md-list-item>
						<md-divider></md-divider>
					<md-list-item>

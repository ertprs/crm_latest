...
function Notebook_Controller($scope, $http, $mdSidenav, $q, $timeout, $filter) {
	"use strict";
	var deferred = $q.defer();
	$scope.order_list = {
		order: '',
	...
	$scope.promise = deferred.promise;
	$http.get(BASE_URL + 'notebooks/get_request_data').then(function (Orders) {
...
CiuisCRM.controller('Notebook_Controller', Notebook_Controller);